...
const Hero = () => {
  ...
  return (
    <>
      <header
        id="header"
        className={`flex justify-end items-center py-[15px] lg:hidden px-[20px] ${
          isHeaderBlurred && "blurred"
        }`}
      >
        <GiHamburgerMenu
          className={`${isDrawerOpen ? " invisible" : "block"}  ${
            isHeaderBlurred
              ? "text-white bg-[#333] p-1 rounded-full"
              : "text-white bg-[#333] p-1 rounded-full"
          } text-[25px]`}
      ...
      <section className="max-w-[1200px] mx-auto px-[20px]">
        ...
        <div className="grid lg:grid-cols-3 gap-5">
          <div className=" bg-white h-fit mt-[30px] rounded-md px-3 pt-4 pb-5 flex flex-col justify-center items-center lg:sticky lg:top-5">
            ...
            <a
              href="/Sarath_R_S_resume.pdf"
              rel="noreferrer noopener"
              download={"Sarath_R_S_resume.pdf"}
